...
const Footer = () => {
  return (
    <footer
      ...
      className="bg-gradient-to-r from-slate-800 via-cyan-600 to-green-600 hover:bg-gradient-to-l hover:from-slate-800 hover:via-slate-700 hover:to-green-700"
    >
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 rounded-lg bg-indigo-600 p-6 shadow-lg sm:flex-row sm:justify-between">
          <strong className="text-xl text-white sm:text-xl">
            Make Your Futute with city university
          </strong>
